...
void loop(){
  ...
  Serial.print("Celcius Temperature : "); //  calculating temperature in celcius
  Serial.print(temp_c);
  Serial.println(" *C");
  Serial.print("Fahrenheit Temperature : "); //  calculate temperature in fahrenheit
  Serial.print(temp_f);
  Serial.println(" *F");
  Serial.print("Kelevin Temperature : ");  //  calculate temperature in kelevin
  Serial.print(temp_k);
  Serial.println(" *K");
  Serial.print("Humidity : "); //  calculate relative humidity
  Serial.print(humidity);
  Serial.println(" % RH");
  Serial.print("Dew point : "); //  calculating dew point
